...
class StrokeViewCNN(nn.Module):
    """Final CNN using raw image, Sobel edge, and stroke-density channels."""

    def __init__(self, num_classes=NUM_CLASSES):
        super().__init__()

        # These weights let the CNN learn how much each image view matters.
